    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Contacts clickedContact = null;
                String selected = ((TextView) view.findViewById(R.id.contactId)).getText().toString();
        ...
        if (contactsCursor.moveToFirst()) {
            do {
                ...
                if (dataCursor.moveToFirst()) {
                    ...
                    contactList.add(new Contacts(Long.toString(contctId),
                            displayName, "", contactNumbers ,contactOtherDetails));// Finally add
                    // items to
                    // array list
                }
